...
export default function ProductCard({ product }: { product: Product }) {
  ...
  return (
    ...
    >
      ...
      {/* Info */}
      <div className="p-4 border-t border-white/10 flex flex-col gap-1.5 flex-1">
        <h3 className="text-sm font-medium text-[#F0EDE6] group-hover:text-[#C9A84C] transition-colors leading-snug">
          {product.name}
        </h3>
