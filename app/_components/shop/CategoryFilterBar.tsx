// app/shop/_components/CategoryFilterBar.tsx
"use client";
              ...
              className={`flex items-center gap-2 px-4 py-2 text-[11px] tracking-widest uppercase transition-all rounded-full border
                ${
                  isActive
                    ...
                    : "text-text border-border hover:text-text hover:border-border"
                }`}
            >
              {cat.name}
              {subCount > 0 && (
                <span
                  ...
                  ${isActive ? "bg-[#0A0A0A]/20" : "bg-border"}`}
                >
                  {subCount}
                </span>
              )}
...
//   return (
//     <div className="border-b border-white/10 px-6 md:px-12 overflow-x-auto scrollbar-none">
//       <div className="flex items-center gap-1 py-3 min-w-max">
//         {tabs.map((cat) => {
//           const isActive = active === cat.slug;
//           return (
...
//                   isActive
//                     ? "bg-[#C9A84C] text-[#0A0A0A] border-[#C9A84C] font-medium"
//                     : "text-[#7A7672] border-white/10 hover:text-[#F0EDE6] hover:border-white/20"
//                 }`}
//             >
//               {cat.name}
//               {/* Show subcategory count badge */}
...
//                   >
//                     {(cat as any).subcategories.length}
//                   </span>
//                 )}
//             </button>
//           );
